    ...
    (let ((bg-back   '(:background back))
      ...
      (mapcar (lambda (face) (apply 'create-face-spec face))
              `(;; basic
                ...
                ;; powerline
                (powerline-active1 (,@fg-base00 ,@bg-base03 :inherit mode-line))
                (powerline-active2 (,@fg-base00 ,@bg-base02 :inherit mode-line))
                (powerline-inactive1 (,@fg-base01 ,@bg-base02 :inherit mode-line-inactive))
                (powerline-inactive2 (,@fg-base01 ,@bg-base03 :inherit mode-line-inactive))
                ;; slime
